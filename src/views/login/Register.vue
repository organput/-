<template>
  <div class="wrapper">
    <img class="wrapper__img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwcNbxorrcMmOE1CtIJVGkpx0Vd_6f_rPKapY6P6MdfE4jy-zlW_9AE2rfBBBKeK7xaVo&usqp=CAU">
